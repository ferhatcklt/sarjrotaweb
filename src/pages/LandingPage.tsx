            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 mt-2">
                  <Link
                    to="/harita"
                    className="group/btn relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-slate-950 rounded-full font-bold text-lg hover:scale-105 transition-all duration-300 shadow-[0_0_30px_rgba(255,255,255,0.1)] w-full sm:w-auto"
                  >
                    Kalkışa Hazırlan
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-8">
                <Link
                  to="/harita"
                  className="inline-flex items-center justify-center px-10 py-5 bg-white text-blue-600 rounded-full font-bold text-xl hover:scale-105 transition-transform shadow-2xl w-full sm:w-auto"
                >
                  Hemen Rota Oluştur
                </Link>
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto justify-center">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start leading-none text-left">
                      ...
                      <span className="text-sm font-bold">İndirin</span>
                    </div>
                  </a>
                </div>
              </div>
