...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#030712] font-['Inter'] transition-colors flex flex-col">
      <SEO 
        title="Hakkımızda | Elektrikli Araç Rota Planlayıcısı ŞarjRota"
        description="ŞarjRota'nın amacı, yapay zeka ve gelişmiş algoritmalar kullanarak elektrikli araç sürücülerine stressiz, güvenli ve en uygun maliyetli rota deneyimini sunmaktır."
      />
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="md:w-2/3">
            ...
            <Link to="/harita" className="inline-flex items-center text-blue-600 dark:text-blue-400 font-semibold hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
