        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-8 sm:p-12 transition-colors">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <ul className="list-disc pl-6 mb-4 text-slate-600 dark:text-slate-300 space-y-2">
              ...
              <li><strong>Google Analytics (GA4) ve Firebase:</strong> Site trafiğini, mobil uygulama kullanımını ve istatistiklerini anonim olarak analiz etmek amacıyla Google Analytics 4 ve Firebase kullanılmaktadır. Bu servisler, tarayıcı çerezleri ve benzer cihaz tanımlayıcı teknolojiler aracılığıyla anonim ziyaretçi verileri toplar. Google'ın veri işleme politikalarına <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 underline">buradan</a> ulaşabilirsiniz.</li>
              <li><strong>Firebase Crashlytics:</strong> Mobil uygulamamızdaki (iOS ve Android) çökmeleri ve hataları tespit ederek uygulama performansını iyileştirmek amacıyla Firebase Crashlytics kullanılmaktadır. Bu araç, uygulamanın çökmesi durumunda anonim hata raporları ve cihaz bilgisi gönderir, kişisel verilerinizi toplamaz.</li>
