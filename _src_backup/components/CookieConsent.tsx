...
export default function CookieConsent() {
  ...
  useEffect(() => {
    ...
    if (!consent) {
      // İlk 1 saniye sonra göster (sayfa yüklendikten sonra)
  ...
  const reject = () => {
    ...
    window[`ga-disable-G-5RKDXVG4PP` as keyof Window] = true as never;
    setVisible(false);
  };
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              ...
              <Link to="/gizlilik" className="text-blue-400 underline underline-offset-2 hover:text-blue-300">Gizlilik Politikası</Link> ve{' '}
              <Link to="/kullanim-sartlari" className="text-blue-400 underline underline-offset-2 hover:text-blue-300">Kullanım Şartları</Link> sayfalarımızı inceleyebilirsiniz.
            </p>
          </div>
