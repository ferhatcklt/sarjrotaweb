 ...
 * 
 * Kullanım:
 *   <AdBanner variant="horizontal" />   → Geniş yatay banner (728x90)
 *   <AdBanner variant="rectangle" />    → Kare/dikdörtgen (300x250)
 *   <AdBanner variant="inline" />       → İçerik arasına ince banner
 */
...
export default function AdBanner({ variant = 'horizontal', className = '' }: AdBannerProps) {
  // İleride burayı gerçek reklam kodu ile değiştireceğiz.
  // Şimdilik boş ama görünmez bir container bırakıyoruz.
  ...
  return (
    <div 
      ...
      aria-hidden="true"
    >
      {/* Reklam alanı — AdSense veya başka bir ağ entegre edildiğinde buraya kod gelecek */}
