...
export default function YeniliklerPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#030712] font-['Inter'] transition-colors flex flex-col">
      <SEO 
        title="Yakında Gelecek Yenilikler | ŞarjRota"
        description="ŞarjRota'ya yakında eklenecek olan gelişmiş rota optimizasyonu, CarPlay desteği ve canlı istasyon durumu gibi harika özellikleri keşfedin."
      />
